...
- [OpenCode](https://opencode.ai) V1 `>=1.18.29 <2` (**tested with 1.18.31**), or V2 `>=2.0.3 <2.0.12` (**tested with 2.0.11**)
...
| OpenCode V2           | `>=2.0.3 <2.0.12`  | Closed compatibility window; verified with **2.0.11**      |
